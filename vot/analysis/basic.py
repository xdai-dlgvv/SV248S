...
from vot.region import Region, Special, calculate_overlaps, calculate_location_errs
...
def compute_OSLE(trajectory: List[Region], sequence: Sequence, burnin: int = 10,
    ignore_unknown: bool = True, bounded: bool = True) -> float:
